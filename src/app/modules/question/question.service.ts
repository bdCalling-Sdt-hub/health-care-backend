import { StatusCodes } from 'http-status-codes';
  ...
  const getAllQuestions = async (queryFields: Record<string, any>): Promise<IQuestion[]> => {
  ...
  const updateQuestion = async (id: string, payload: IQuestion): Promise<IQuestion | null> => {
